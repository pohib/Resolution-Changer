    ...
    public partial class Form1 : Form
    {
                ...
                else
                {
                    ...
                    switch (iRet)
                    {
                        case (int)DISP_CHANGE.SUCCESSFUL:
                            {
                                return "Разрешение успешно изменено!";
                            }
        ...
        private void MonitorProcess()
        {
            while (monitoring)
            {
                ...
                {
                    UpdateStatus("Процесс запущен! Меняем разрешение...");
                ...
                {
                    UpdateStatus("Процесс закрыт! Возвращаем исходное разрешение...");
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            if (!monitoring)
            {
                ...
                monitorThread.Start();
                btnStart.Text = "Остановить мониторинг";
                UpdateStatus("Мониторинг процесса запущен...");
            }
            else
            {
                monitoring = false;
                ...
                UpdateStatus("Мониторинг процесса остановлен");
            }
        }
